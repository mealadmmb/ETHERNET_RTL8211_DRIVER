...
proc create_hier_cell_AD9361 { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M00_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins axi_ad9361/s_axi]
  ...
  connect_bd_net -net sys_cpu_clk [get_bd_pins s_axi_aclk] [get_bd_pins axi_ad9361/s_axi_aclk] [get_bd_pins util_ad9361_tdd_sync/clk]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_ad9361/s_axi_aresetn] [get_bd_pins util_ad9361_tdd_sync/rstn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: RTL8211_F_Serial_man_0, and set properties
  set block_name RTL8211_F_Serial_manger
  set block_cell_name RTL8211_F_Serial_man_0
  if { [catch {set RTL8211_F_Serial_man_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $RTL8211_F_Serial_man_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {clk_out125} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLK_OUT1_PORT {clk_out_5} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#ENET Reset#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#USB Reset#GPIO#GPIO#GPIO#GPIO#GPIO} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#reset#gpio[8]#gpio[9]#gpio[10]#gpio[11]#tx#rx#gpio[14]#gpio[15]#gpio[16]#gpio[17]#gpio[18]#gpio[19]#gpio[20]#gpio[21]#gpio[22]#gpio[23]#gpio[24]#gpio[25]#gpio[26]#gpio[27]#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#gpio[47]#reset#gpio[49]#gpio[50]#gpio[51]#gpio[52]#gpio[53]} \
  ...
  connect_bd_intf_net -intf_net axi_cpu_interconnect_M00_AXI [get_bd_intf_pins AD9361/s_axi] [get_bd_intf_pins axi_cpu_interconnect/M00_AXI]
  connect_bd_intf_net -intf_net sys_ps7_DDR [get_bd_intf_ports ddr] [get_bd_intf_pins sys_ps7/DDR]
  connect_bd_intf_net -intf_net sys_ps7_FIXED_IO [get_bd_intf_ports fixed_io] [get_bd_intf_pins sys_ps7/FIXED_IO]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports mdio] [get_bd_pins RTL8211_F_Serial_man_0/mdio]
  connect_bd_net -net RTL8211_F_Serial_man_0_mdc [get_bd_ports mdc] [get_bd_pins RTL8211_F_Serial_man_0/mdc]
  connect_bd_net -net RTL8211_F_Serial_man_0_rd_tdata [get_bd_pins RTL8211_F_Serial_man_0/rd_tdata] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net RTL8211_F_Serial_man_0_rd_tvalid [get_bd_pins RTL8211_F_Serial_man_0/rd_tvalid] [get_bd_pins system_ila_0/probe1]
  connect_bd_net -net RTL8211_F_Serial_man_0_tcntr [get_bd_pins RTL8211_F_Serial_man_0/tcntr] [get_bd_pins system_ila_0/probe2]
  ...
  connect_bd_net -net clk_61_38_1 [get_bd_ports clk_out] [get_bd_pins AD9361/clk_out]
  connect_bd_net -net clk_wiz_0_clk_out125 [get_bd_ports clk_out125_0] [get_bd_pins clk_wiz_0/clk_out125]
  connect_bd_net -net clk_wiz_1_clk_out_5 [get_bd_pins RTL8211_F_Serial_man_0/i_clk] [get_bd_pins clk_wiz_1/clk_out_5]
  ...
  connect_bd_net -net sys_cpu_clk [get_bd_ports ps_clk] [get_bd_pins AD9361/s_axi_aclk] [get_bd_pins axi_cpu_interconnect/ACLK] [get_bd_pins axi_cpu_interconnect/M00_ACLK] [get_bd_pins axi_cpu_interconnect/S00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins sys_ps7/FCLK_CLK0] [get_bd_pins sys_ps7/M_AXI_GP0_ACLK] [get_bd_pins sys_rstgen/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins vio_0/clk]
  connect_bd_net -net sys_cpu_resetn [get_bd_pins AD9361/s_axi_aresetn] [get_bd_pins axi_cpu_interconnect/ARESETN] [get_bd_pins axi_cpu_interconnect/M00_ARESETN] [get_bd_pins axi_cpu_interconnect/S00_ARESETN] [get_bd_pins sys_rstgen/peripheral_aresetn]
  ...
  connect_bd_net -net vio_0_probe_out0 [get_bd_pins RTL8211_F_Serial_man_0/rdwr] [get_bd_pins vio_0/probe_out0]
  connect_bd_net -net vio_0_probe_out1 [get_bd_pins RTL8211_F_Serial_man_0/start] [get_bd_pins vio_0/probe_out1]
  connect_bd_net -net vio_0_probe_out2 [get_bd_pins RTL8211_F_Serial_man_0/taddr] [get_bd_pins vio_0/probe_out2]
  connect_bd_net -net vio_0_probe_out3 [get_bd_pins RTL8211_F_Serial_man_0/value] [get_bd_pins vio_0/probe_out3]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins RTL8211_F_Serial_man_0/reset] [get_bd_pins xlconstant_0/dout]
